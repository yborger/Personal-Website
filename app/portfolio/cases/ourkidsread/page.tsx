...
const phases = [
  ...
  },
  {
    ...
    description: "I approached the redesign using reusable interface patterns instead of isolated page layouts. For example, the sections for people and organizations was given the same component layout.",
    ...
    image: "/okr_imgs/component_design.png",
    bg: "#D4537E",
  },
  {
    number: 5,
  ...
  },
  {
    ...
    details: "After presenting our initial wireframes, the organization's founder explained that the website needed to focus less on showcasing the organization itself and more on guiding people toward getting involved. Based on this feedback, we restructured the homepage to emphasize storytelling and community impact, and a volunteer portal that encouraged participation and engagement.",
    image: "/okr_imgs/volunteer.png",
    bg: "#C4895A",
  },
  {
    number: 7,
